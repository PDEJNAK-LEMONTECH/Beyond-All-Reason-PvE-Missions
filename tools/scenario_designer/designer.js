...
function newState(map){
  return {
    ...
    meta: { title:'New Scenario', author:'', summary:'', briefing:'',
            difficulty:'normal', missionFile: slug(map.name)+'_mission', scenarioIndex:26 },
...
function exportScenario(idx){
  ...
  p('\t[modoptions] { scenariooptions = __SCENARIOOPTIONS__; mission_path = '+mp+'; mission_difficulty = '+(T.meta.difficulty||'normal')+'; }');
...
function exportStartScript(gametypeToken){
  ...
  p('\t[modoptions] { mission_path = '+mp+'; mission_difficulty = '+(T.meta.difficulty||'normal')+(infLos?'; mission_debug_los = 1':'')+'; }');
